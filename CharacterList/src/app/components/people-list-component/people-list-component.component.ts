...
import { Gender, Character } from 'src/app/models/characterList.interface';
...
export class PeopleListComponentComponent {
  characterList: Character[] = CHARACTERLIST.results;

  selectedCharacter:Character | undefined;
  constructor(private modalService: NgbModal) { }

  openCharacterModal(c:Character, modal: any) {
